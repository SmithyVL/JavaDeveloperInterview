...
[![Обсуждение](../../docs/assets/other/discussions.png "Обсудить")](https://github.com/SmithyVL/JavaDeveloperInterview/discussions/10)

***
<div style="display: flex">
    <div style="width: 25%">
        <a href="../../oop/question-9/QUESTION9.md" style="text-decoration: none; color: mediumseagreen">
            <img alt="back" src="../../docs/assets/navigation/back.png"/>
            <span style="position: relative; top: -17px;">Выражения "является" и "имеет" в ООП</span>
        </a>
    </div>
